...
const AddProject = (props) => {
  return (
    <div>
      ...
      <input className='projectInput' placeholder="Description" onChange={props.onInput} name="projectDesc"></input><br/>
      <input className='projectInput' placeholder="Image (900x506)" onChange={props.onInput} name="projectImg"></input><br/>
